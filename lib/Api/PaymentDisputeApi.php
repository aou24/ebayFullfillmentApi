...
class PaymentDisputeApi
{
     ...
     */
    protected function acceptPaymentDisputeRequest($payment_dispute_id, $accept_payment_dispute_request = null)
    {
        ...
        if (isset($accept_payment_dispute_request)) {
            $_tempBody = $accept_payment_dispute_request;
        }
     ...
     * @param  \OpenAPI\Client\Model\AddEvidenceRequest $add_evidence_request add_evidence_request (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\AddEvidenceResponse
     */
    public function addEvidence($payment_dispute_id, $add_evidence_request = null)
    {
        list($response) = $this->addEvidenceWithHttpInfo($payment_dispute_id, $add_evidence_request);
        return $response;
    }
     ...
     *
     * @param  string $payment_dispute_id This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to add evidence for a contested payment dispute. This identifier is automatically created by eBay once the payment dispute comes into the eBay managed payments system. The unique identifier for payment disputes is returned in the paymentDisputeId field in the getPaymentDisputeSummaries response. This path parameter is required, and the actual identifier value is passed in right after the payment_dispute resource. See the Resource URI above. (required)
     * @param  \OpenAPI\Client\Model\AddEvidenceRequest $add_evidence_request (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\AddEvidenceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function addEvidenceWithHttpInfo($payment_dispute_id, $add_evidence_request = null)
    {
        $request = $this->addEvidenceRequest($payment_dispute_id, $add_evidence_request);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\AddEvidenceResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\AddEvidenceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\AddEvidenceResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\AddEvidenceResponse',
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addEvidenceAsync($payment_dispute_id, $add_evidence_request = null)
    {
        return $this->addEvidenceAsyncWithHttpInfo($payment_dispute_id, $add_evidence_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addEvidenceAsyncWithHttpInfo($payment_dispute_id, $add_evidence_request = null)
    {
        $returnType = '\OpenAPI\Client\Model\AddEvidenceResponse';
        $request = $this->addEvidenceRequest($payment_dispute_id, $add_evidence_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function addEvidenceRequest($payment_dispute_id, $add_evidence_request = null)
    {
        // verify the required parameter 'payment_dispute_id' is set
        if ($payment_dispute_id === null || (is_array($payment_dispute_id) && count($payment_dispute_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // body params
        $_tempBody = null;
        if (isset($add_evidence_request)) {
            $_tempBody = $add_evidence_request;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function contestPaymentDisputeRequest($payment_dispute_id, $contest_payment_dispute_request = null)
    {
        // verify the required parameter 'payment_dispute_id' is set
        if ($payment_dispute_id === null || (is_array($payment_dispute_id) && count($payment_dispute_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($contest_payment_dispute_request)) {
            $_tempBody = $contest_payment_dispute_request;
        }
     ...
     * @param  \OpenAPI\Client\Model\UpdateEvidenceRequest $update_evidence_request update_evidence_request (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updateEvidence($payment_dispute_id, $update_evidence_request = null)
    {
        $this->updateEvidenceWithHttpInfo($payment_dispute_id, $update_evidence_request);
    }
     ...
     *
     * @param  string $payment_dispute_id This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to update the evidence set for a contested payment dispute. This identifier is automatically created by eBay once the payment dispute comes into the eBay managed payments system. The unique identifier for payment disputes is returned in the paymentDisputeId field in the getPaymentDisputeSummaries response. This path parameter is required, and the actual identifier value is passed in right after the payment_dispute resource. See the Resource URI above. (required)
     * @param  \OpenAPI\Client\Model\UpdateEvidenceRequest $update_evidence_request (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateEvidenceWithHttpInfo($payment_dispute_id, $update_evidence_request = null)
    {
        $request = $this->updateEvidenceRequest($payment_dispute_id, $update_evidence_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEvidenceAsync($payment_dispute_id, $update_evidence_request = null)
    {
        return $this->updateEvidenceAsyncWithHttpInfo($payment_dispute_id, $update_evidence_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEvidenceAsyncWithHttpInfo($payment_dispute_id, $update_evidence_request = null)
    {
        $returnType = '';
        $request = $this->updateEvidenceRequest($payment_dispute_id, $update_evidence_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateEvidenceRequest($payment_dispute_id, $update_evidence_request = null)
    {
        // verify the required parameter 'payment_dispute_id' is set
        if ($payment_dispute_id === null || (is_array($payment_dispute_id) && count($payment_dispute_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // body params
        $_tempBody = null;
        if (isset($update_evidence_request)) {
            $_tempBody = $update_evidence_request;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function uploadEvidenceFileRequest($payment_dispute_id)
    {
        // verify the required parameter 'payment_dispute_id' is set
        if ($payment_dispute_id === null || (is_array($payment_dispute_id) && count($payment_dispute_id) === 0)) {
            throw new \InvalidArgumentException(
