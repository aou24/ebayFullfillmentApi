...
class ReturnAddress implements ModelInterface, ArrayAccess
{
     ...
     * Sets country
     *
     * @param string|null $country The country's two-digt, ISO 3166-1 country code. See the enumeration type for a country's value. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/fulfillment/types/CountryCodeEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
