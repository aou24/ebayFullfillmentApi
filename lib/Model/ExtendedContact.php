...
class ExtendedContact implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'company_name' => 'string',
        'contact_address' => '\OpenAPI\Client\Model\Address',
        'email' => 'string',
        'full_name' => 'string',
        'primary_phone' => '\OpenAPI\Client\Model\PhoneNumber'
    ];
     ...
     *
     * @param \OpenAPI\Client\Model\Address|null $contact_address contact_address
     *
     * @return $this
     */
     ...
     * Sets primary_phone
     *
     * @param \OpenAPI\Client\Model\PhoneNumber|null $primary_phone primary_phone
     *
     * @return $this
     */
