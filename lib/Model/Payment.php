...
class Payment implements ModelInterface, ArrayAccess
{
     ...
     * Sets payment_method
     *
     * @param string|null $payment_method The payment method used by the buyer to pay for the order. See the PaymentMethodTypeEnum type for more information on the payment methods. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/fulfillment/types/PaymentMethodTypeEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     *
     * @param string|null $payment_reference_id This field is only returned if payment has been made by the buyer, and the paymentMethod is PAYPAL. This field contains the PayPal-generated transaction identifier.
     *
     * @return $this
     */
