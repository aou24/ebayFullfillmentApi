...
class OrderLineItems implements ModelInterface, ArrayAccess
{
     ...
     * Sets item_id
     *
     * @param string|null $item_id The unique identifier of the eBay listing associated with the order.
     *
     * @return $this
     */
