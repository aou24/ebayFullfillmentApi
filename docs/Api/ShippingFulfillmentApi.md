...
> object createShippingFulfillment($order_id, $shipping_fulfillment_details)
...
> \OpenAPI\Client\Model\ShippingFulfillment getShippingFulfillment($fulfillment_id, $order_id)
...
> \OpenAPI\Client\Model\ShippingFulfillmentPagedCollection getShippingFulfillments($order_id)
