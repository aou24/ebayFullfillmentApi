...
> \OpenAPI\Client\Model\Order getOrder($order_id)
...
> \OpenAPI\Client\Model\OrderSearchPagedCollection getOrders($filter, $limit, $offset, $order_ids)
...
> \OpenAPI\Client\Model\Refund issueRefund($order_id, $issue_refund_request)
